...
/**
 * This event is generated after the parsing of all data lines have been performed. There are
 * several parameters that should be filed by routines that generate this event, such as in the
 * {@link com.panayotis.jubler.subs.loader.AbstractBinarySubFormat#firePostParseActionEvent
 * firePostParseActionEvent} method within the {@link
 * com.panayotis.jubler.subs.loader.AbstractBinarySubFormat}.
 *
 * <ol>
 *   <li>The reference to the subitle-file processed.
 *   <li>The reference to the parsed list of subtitle events.
...
public class PostParseActionEvent extends ActionEvent {
  ...
  /**
   * The frame rate per second, by default it is 25fps, the rate of digital media, not as 24fps in
   * the film media.
   */
   ...
   *
   * @return The reference to the loaded subtitle list, null if the reference has not been set.
   */
   ...
   *
   * @return The reference to the subitle file being loaded, null if the reference has not been set.
   */
