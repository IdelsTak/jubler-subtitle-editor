...
/**
 * This class provides a template for processes listens to {@link SubtitleRecordCreatedEvent}. It
 * provides a mechanism for inserting code blocks that must be executed when the event is raised.
 * <br>
 * <br>
...
public interface SubtitleRecordCreatedEventListener {
  ...
  /**
   * The entry point to code blocks that must be executed when a record has been created.
   *
