...
/**
 * This class is base class for all subtitle updating events that are threaded. It holds the list
 * and routines to fire events before and after the processing are done, and after a subtitle-record
 * has been updated.
 *
...
public class SubtitleUpdaterThread extends Thread {
  ...
  private int row = -1;
  private ArrayList<SubtitleRecordUpdatedEventListener> recordUpdatedEventList =
      new ArrayList<SubtitleRecordUpdatedEventListener>();
  private ArrayList<SubtitleUpdaterPreProcessingEventListener> updaterPreProcessingEventList =
      new ArrayList<SubtitleUpdaterPreProcessingEventListener>();
  private ArrayList<SubtitleUpdaterPostProcessingEventListener> updaterPostProcessingEventList =
      new ArrayList<SubtitleUpdaterPostProcessingEventListener>();
  ...
  public void addSubtitleUpdaterPreProcessingEventListener(
      SubtitleUpdaterPreProcessingEventListener l) {
    this.updaterPreProcessingEventList.add(l);
  }

  public void removeSubtitleUpdaterPreProcessingEventListener(
      SubtitleUpdaterPreProcessingEventListener l) {
  ...
  public void fireSubtitleUpdaterPreProcessingEvent() {
    SubtitleUpdaterPreProcessingEvent event =
        new SubtitleUpdaterPreProcessingEvent(
            this, ActionEvent.ACTION_PERFORMED, "Subtitle Updater Pre-Processing Event");
  ...
  public void fireSubtitleRecordUpdatedEvent() {
    SubtitleRecordUpdatedEvent event =
        new SubtitleRecordUpdatedEvent(this, ActionEvent.ACTION_PERFORMED, "Subtitle Updated");
  ...
  public void addSubtitleUpdaterPostProcessingEventListener(
      SubtitleUpdaterPostProcessingEventListener l) {
    this.updaterPostProcessingEventList.add(l);
  }

  public void removeSubtitleUpdaterPostProcessingEventListener(
      SubtitleUpdaterPostProcessingEventListener l) {
  ...
  public void fireSubtitleUpdaterPostProcessingEvent() {
    SubtitleUpdaterPostProcessingEvent event =
        new SubtitleUpdaterPostProcessingEvent(
            this, ActionEvent.ACTION_PERFORMED, "Subtitle Updater Post-Processing Event");
    event.setSubList(subList);
  ...
  public ArrayList<SubtitleRecordUpdatedEventListener> getRecordUpdatedEventList() {
    return recordUpdatedEventList;
  }

  public ArrayList<SubtitleUpdaterPreProcessingEventListener> getUpdaterPreProcessingEventList() {
    return updaterPreProcessingEventList;
  }

  public ArrayList<SubtitleUpdaterPostProcessingEventListener> getUpdaterPostProcessingEventList() {
