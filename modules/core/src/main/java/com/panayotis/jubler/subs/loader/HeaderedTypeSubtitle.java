...
/**
 * This file is a template for subtitle which contains header, such as TMPGenc or SON, SWT.
 *
...
public interface HeaderedTypeSubtitle {
   ...
   *
   * @return Reference of a header object, or null if the reference has not been set.
   */
