...
public class LayoutDataItemRecord implements TMPGencPatternDef, java.lang.Cloneable {
  ...
  /**
   * The internal number format instance. This is used to format numerical values when it is
   * required to convert values into string format.
   */
  public static NumberFormat fmt = NumberFormat.getInstance();
  /** the human readable name of the layout */
  private String name = null;
  /**
   * the displaying area of the subtitle text on the screen. See the definition of values that this
   * variable may have at any one time at the top of this file.
   */
  private byte displayArea = 0;
  /** the name of the font being used */
  private String fontName = null;
  /**
   * the size of the fond being used. This value is a fractional number, indicating the percentage
   * of the font size.
   */
  private float forntSize = 0.0F; // percent
  /**
   * This the combination of R. G. B. values. It is a very large value and currently I have no idea
   * how this value is formed by the TMPGenc software. There are supposedly to be 16 different
   * colors.
   */
  ...
  /**
   * Gets the size of the font being used. This value is a fractional number indicating percentage.
   *
  ...
  /**
   * Sets the font size being used. This value is a fractional number indicating percentage.
   *
  ...
  /**
   * Gets the value for the text rotation. A non zero value indicates that the text rotation is
   * being used.
   *
  ...
  /**
   * Sets the text rotation. A non zero value indicates that the text rotation is being used.
   *
  ...
  /**
   * Checks to see if the text border is being used on not a zero value indicates that the text
   * border is not being used, a non zero value indicates that the text border is actually being
   * used.
   *
