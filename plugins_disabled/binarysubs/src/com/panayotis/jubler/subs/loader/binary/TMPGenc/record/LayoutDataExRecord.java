...
/**
 * This class hold patterns to recognise and parse data line from the [LayoutDataEx] section. The
 * typical data example is shown below:
 *
 * <blockquote>
 *
 * <pre>
 * [LayoutDataEx]
 * <i><b>0,0 1,0 1,0 1,1</b></i>
 * </pre>
 *
 * </blockquote>
 *
 * The setting of each line affects the corresponding layout in the [LayoutData] section and
 * subtitle events using the corresponding layout will affect by this setting. The setting
 * definitions are:
 *
 * <ol>
 *   <li>First number (left): centered text or not - 0: centered, 1: left align
 *   <li>Second number (right): readingDirection - left to right 0: reading left to right alignment,
 *       1: reading right to left
 * </ol>
 *
...
public class LayoutDataExRecord implements TMPGencPatternDef {
  ...
  public int readingDirection =
      0; // left to right 0: reading left to right alignment, 1: reading right to left
