 ...
 */
public class TMPGencSubtitleRecord extends SubEntry
    implements TMPGencPatternDef, HeaderedTypeSubtitle {

  private TMPGencHeaderRecord header = null;
  private int id = -1;
  /**
   * The index to the {@link dvdsubtitlemanager.Records.TMPGenc.LayoutDataRecord} This value is used
   * in the TMPGenc DVD Authoring software to identify the layout chosen for the subtitle event.
   */
  private int layoutIndex;
  /**
   * This is guessed to be the enabled, but is not 100% sure, but the value is used in the TMPGenc
  ...
  /**
   * Sets the enability of the susbtitle event. That is whether the subtitle event will be displayed
   * on playback or not.
   *
  ...
  /**
   * Converts the record to a string representation. If the version for writing out to files is
   * required than the new line character will be made platform dependent.
   *
   * @param separator
   * @return the string representation of the record
   */
  public String toString(String separator) {
    // 1,1,"00:01:57,470","00:02:00,720",1,"Think to yourself personally\nthat every day is your
    // last."
  ...
  /**
   * Converts the record to a string representation. This version is platform independent and is
  ...
  /**
   * Converts the record to a string representation This version is platform dependent and is used
   * externally for writing to files.
   *
   * @return the string representation of the record
   */
