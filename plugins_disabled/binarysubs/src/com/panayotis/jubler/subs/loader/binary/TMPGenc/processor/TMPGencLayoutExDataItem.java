...
/**
 * This class hold the pattern to identify item lines from the "[LayoutDataEx]" section Typical data
 * in this block will look like the following excerpt:
 *
 * <blockquote>
 *
 * <pre>
 ...
 * </blockquote>
 *
 * For each line the first number refers to the text alignment and the second number refers to the
 * reading direction. This setting affects the subtitle-events which uses the corresponding layout
 * definition in the [LayoutData] section.
 *
 * <p>First number (left): centered text or not - 0: centered, 1: left align Second number (right):
 * readingDirection - left to right 0: reading left to right alignment, 1: reading right to left
 *
