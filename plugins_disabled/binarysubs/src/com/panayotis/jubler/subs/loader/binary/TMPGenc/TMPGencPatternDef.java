...
/**
 * The interface holds the common definitions of patterns used during the processing of a TMPGenc
 * subtitle file.
 *
...
public interface TMPGencPatternDef extends CommonDef {
  ...
  /**
   * Character for TMPGenc new line marker which is embedded in the subtitle text part. ("\\\\n").
   * This pattern is used for filters to recognize and parse during the reading operation only.
   * Typical example:
   *
   * <pre>
  ...
  /**
   * Pattern to recognize the TMPGenc's subtitle time component. Typical data appears like the
   * following excerpt.
   *
   * <pre>
   * "00:01:57,470"
