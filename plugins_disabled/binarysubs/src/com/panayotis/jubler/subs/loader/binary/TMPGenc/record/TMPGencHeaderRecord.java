...
/**
 * This class hold references to two lists of items, considering to be the header of the TMPGenc
 * subtitle data file. They are items from [LayoutData] section, and [LayoutDataEx] section.
 *
...
public class TMPGencHeaderRecord implements TMPGencPatternDef {
  ...
  /**
   * Produce the header data block with header for each section, including the header for the
   * '[ItemData]' block. Typical output produces somthing like:
   *
   * <blockquote>
   *
   * <pre>
