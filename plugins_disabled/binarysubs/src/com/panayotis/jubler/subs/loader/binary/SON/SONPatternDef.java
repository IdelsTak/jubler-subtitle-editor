...
/**
 * This interface holds the most commonly used patter definitions for SON subtitle format.
 *
...
public interface SONPatternDef extends CommonDef {
  ...
  public static String sonSubtitleEventHeaderLine =
      "SP_NUMBER" + "\t" + "START" + "\t" + "END" + "\t" + "FILE_NAME";
  /** "(?i)SP_NUMBER" + sp + "START" + sp + "END" + sp + "FILE_NAME" */
  public static String p_son_subtitle_event_header =
      "(?i)SP_NUMBER" + sp + "START" + sp + "END" + sp + "FILE_NAME";
  /** "#" */
